...
declare module 'typed-screeps' {

// Game Constants

const OK: OK;
const ERR_NOT_OWNER: ERR_NOT_OWNER;
const ERR_NO_PATH: ERR_NO_PATH;
const ERR_NAME_EXISTS: ERR_NAME_EXISTS;
const ERR_BUSY: ERR_BUSY;
const ERR_NOT_FOUND: ERR_NOT_FOUND;
const ERR_NOT_ENOUGH_RESOURCES: ERR_NOT_ENOUGH_RESOURCES;
const ERR_NOT_ENOUGH_ENERGY: ERR_NOT_ENOUGH_ENERGY;
const ERR_INVALID_TARGET: ERR_INVALID_TARGET;
const ERR_FULL: ERR_FULL;
const ERR_NOT_IN_RANGE: ERR_NOT_IN_RANGE;
const ERR_INVALID_ARGS: ERR_INVALID_ARGS;
const ERR_TIRED: ERR_TIRED;
const ERR_NO_BODYPART: ERR_NO_BODYPART;
const ERR_NOT_ENOUGH_EXTENSIONS: ERR_NOT_ENOUGH_EXTENSIONS;
const ERR_RCL_NOT_ENOUGH: ERR_RCL_NOT_ENOUGH;
const ERR_GCL_NOT_ENOUGH: ERR_GCL_NOT_ENOUGH;

const FIND_EXIT_TOP: FIND_EXIT_TOP;
const FIND_EXIT_RIGHT: FIND_EXIT_RIGHT;
const FIND_EXIT_BOTTOM: FIND_EXIT_BOTTOM;
const FIND_EXIT_LEFT: FIND_EXIT_LEFT;
const FIND_EXIT: FIND_EXIT;
const FIND_CREEPS: FIND_CREEPS;
const FIND_MY_CREEPS: FIND_MY_CREEPS;
const FIND_HOSTILE_CREEPS: FIND_HOSTILE_CREEPS;
const FIND_SOURCES_ACTIVE: FIND_SOURCES_ACTIVE;
const FIND_SOURCES: FIND_SOURCES;
const FIND_DROPPED_RESOURCES: FIND_DROPPED_RESOURCES;
const FIND_STRUCTURES: FIND_STRUCTURES;
const FIND_MY_STRUCTURES: FIND_MY_STRUCTURES;
const FIND_HOSTILE_STRUCTURES: FIND_HOSTILE_STRUCTURES;
const FIND_FLAGS: FIND_FLAGS;
const FIND_CONSTRUCTION_SITES: FIND_CONSTRUCTION_SITES;
const FIND_MY_SPAWNS: FIND_MY_SPAWNS;
const FIND_HOSTILE_SPAWNS: FIND_HOSTILE_SPAWNS;
const FIND_MY_CONSTRUCTION_SITES: FIND_MY_CONSTRUCTION_SITES;
const FIND_HOSTILE_CONSTRUCTION_SITES: FIND_HOSTILE_CONSTRUCTION_SITES;
const FIND_MINERALS: FIND_MINERALS;
const FIND_NUKES: FIND_NUKES;
const FIND_TOMBSTONES: FIND_TOMBSTONES;
const FIND_POWER_CREEPS: FIND_POWER_CREEPS;
const FIND_MY_POWER_CREEPS: FIND_MY_POWER_CREEPS;
const FIND_HOSTILE_POWER_CREEPS: FIND_HOSTILE_POWER_CREEPS;
const FIND_DEPOSITS: FIND_DEPOSITS;
const FIND_RUINS: FIND_RUINS;
...
const COLOR_PURPLE: COLOR_PURPLE;
const COLOR_BLUE: COLOR_BLUE;
const COLOR_CYAN: COLOR_CYAN;
const COLOR_GREEN: COLOR_GREEN;
const COLOR_YELLOW: COLOR_YELLOW;
const COLOR_ORANGE: COLOR_ORANGE;
const COLOR_BROWN: COLOR_BROWN;
const COLOR_GREY: COLOR_GREY;
const COLOR_WHITE: COLOR_WHITE;
const COLORS_ALL: ColorConstant[];
...
const BODYPARTS_ALL: BodyPartConstant[];
...
const CONSTRUCTION_COST: Record<BuildableStructureConstant, number>;

const CONSTRUCTION_COST_ROAD_SWAMP_RATIO: 5;
const CONSTRUCTION_COST_ROAD_WALL_RATIO: 150;

const STRUCTURE_EXTENSION: STRUCTURE_EXTENSION;
const STRUCTURE_RAMPART: STRUCTURE_RAMPART;
const STRUCTURE_ROAD: STRUCTURE_ROAD;
const STRUCTURE_SPAWN: STRUCTURE_SPAWN;
const STRUCTURE_LINK: STRUCTURE_LINK;
const STRUCTURE_WALL: STRUCTURE_WALL;
const STRUCTURE_KEEPER_LAIR: STRUCTURE_KEEPER_LAIR;
const STRUCTURE_CONTROLLER: STRUCTURE_CONTROLLER;
const STRUCTURE_STORAGE: STRUCTURE_STORAGE;
const STRUCTURE_TOWER: STRUCTURE_TOWER;
const STRUCTURE_OBSERVER: STRUCTURE_OBSERVER;
const STRUCTURE_POWER_BANK: STRUCTURE_POWER_BANK;
const STRUCTURE_POWER_SPAWN: STRUCTURE_POWER_SPAWN;
const STRUCTURE_EXTRACTOR: STRUCTURE_EXTRACTOR;
const STRUCTURE_LAB: STRUCTURE_LAB;
const STRUCTURE_TERMINAL: STRUCTURE_TERMINAL;
const STRUCTURE_CONTAINER: STRUCTURE_CONTAINER;
const STRUCTURE_NUKER: STRUCTURE_NUKER;
const STRUCTURE_FACTORY: STRUCTURE_FACTORY;
const STRUCTURE_INVADER_CORE: STRUCTURE_INVADER_CORE;
const STRUCTURE_PORTAL: STRUCTURE_PORTAL;

const RESOURCE_ENERGY: RESOURCE_ENERGY;
const RESOURCE_POWER: RESOURCE_POWER;
const RESOURCE_OPS: RESOURCE_OPS;
const RESOURCE_UTRIUM: RESOURCE_UTRIUM;
const RESOURCE_LEMERGIUM: RESOURCE_LEMERGIUM;
const RESOURCE_KEANIUM: RESOURCE_KEANIUM;
const RESOURCE_GHODIUM: RESOURCE_GHODIUM;
const RESOURCE_ZYNTHIUM: RESOURCE_ZYNTHIUM;
const RESOURCE_OXYGEN: RESOURCE_OXYGEN;
const RESOURCE_HYDROGEN: RESOURCE_HYDROGEN;
const RESOURCE_CATALYST: RESOURCE_CATALYST;
const RESOURCE_HYDROXIDE: RESOURCE_HYDROXIDE;
const RESOURCE_ZYNTHIUM_KEANITE: RESOURCE_ZYNTHIUM_KEANITE;
const RESOURCE_UTRIUM_LEMERGITE: RESOURCE_UTRIUM_LEMERGITE;
const RESOURCE_UTRIUM_HYDRIDE: RESOURCE_UTRIUM_HYDRIDE;
const RESOURCE_UTRIUM_OXIDE: RESOURCE_UTRIUM_OXIDE;
const RESOURCE_KEANIUM_HYDRIDE: RESOURCE_KEANIUM_HYDRIDE;
const RESOURCE_KEANIUM_OXIDE: RESOURCE_KEANIUM_OXIDE;
const RESOURCE_LEMERGIUM_HYDRIDE: RESOURCE_LEMERGIUM_HYDRIDE;
const RESOURCE_LEMERGIUM_OXIDE: RESOURCE_LEMERGIUM_OXIDE;
const RESOURCE_ZYNTHIUM_HYDRIDE: RESOURCE_ZYNTHIUM_HYDRIDE;
const RESOURCE_ZYNTHIUM_OXIDE: RESOURCE_ZYNTHIUM_OXIDE;
const RESOURCE_GHODIUM_HYDRIDE: RESOURCE_GHODIUM_HYDRIDE;
const RESOURCE_GHODIUM_OXIDE: RESOURCE_GHODIUM_OXIDE;
const RESOURCE_UTRIUM_ACID: RESOURCE_UTRIUM_ACID;
const RESOURCE_UTRIUM_ALKALIDE: RESOURCE_UTRIUM_ALKALIDE;
const RESOURCE_KEANIUM_ACID: RESOURCE_KEANIUM_ACID;
const RESOURCE_KEANIUM_ALKALIDE: RESOURCE_KEANIUM_ALKALIDE;
const RESOURCE_LEMERGIUM_ACID: RESOURCE_LEMERGIUM_ACID;
const RESOURCE_LEMERGIUM_ALKALIDE: RESOURCE_LEMERGIUM_ALKALIDE;
const RESOURCE_ZYNTHIUM_ACID: RESOURCE_ZYNTHIUM_ACID;
const RESOURCE_ZYNTHIUM_ALKALIDE: RESOURCE_ZYNTHIUM_ALKALIDE;
const RESOURCE_GHODIUM_ACID: RESOURCE_GHODIUM_ACID;
const RESOURCE_GHODIUM_ALKALIDE: RESOURCE_GHODIUM_ALKALIDE;
const RESOURCE_CATALYZED_UTRIUM_ACID: RESOURCE_CATALYZED_UTRIUM_ACID;
const RESOURCE_CATALYZED_UTRIUM_ALKALIDE: RESOURCE_CATALYZED_UTRIUM_ALKALIDE;
const RESOURCE_CATALYZED_KEANIUM_ACID: RESOURCE_CATALYZED_KEANIUM_ACID;
const RESOURCE_CATALYZED_KEANIUM_ALKALIDE: RESOURCE_CATALYZED_KEANIUM_ALKALIDE;
const RESOURCE_CATALYZED_LEMERGIUM_ACID: RESOURCE_CATALYZED_LEMERGIUM_ACID;
const RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE: RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE;
const RESOURCE_CATALYZED_ZYNTHIUM_ACID: RESOURCE_CATALYZED_ZYNTHIUM_ACID;
const RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE: RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE;
const RESOURCE_CATALYZED_GHODIUM_ACID: RESOURCE_CATALYZED_GHODIUM_ACID;
const RESOURCE_CATALYZED_GHODIUM_ALKALIDE: RESOURCE_CATALYZED_GHODIUM_ALKALIDE;

const RESOURCE_BIOMASS: RESOURCE_BIOMASS;
const RESOURCE_METAL: RESOURCE_METAL;
const RESOURCE_MIST: RESOURCE_MIST;
const RESOURCE_SILICON: RESOURCE_SILICON;

const RESOURCE_UTRIUM_BAR: RESOURCE_UTRIUM_BAR;
const RESOURCE_LEMERGIUM_BAR: RESOURCE_LEMERGIUM_BAR;
const RESOURCE_ZYNTHIUM_BAR: RESOURCE_ZYNTHIUM_BAR;
const RESOURCE_KEANIUM_BAR: RESOURCE_KEANIUM_BAR;
const RESOURCE_GHODIUM_MELT: RESOURCE_GHODIUM_MELT;
const RESOURCE_OXIDANT: RESOURCE_OXIDANT;
const RESOURCE_REDUCTANT: RESOURCE_REDUCTANT;
const RESOURCE_PURIFIER: RESOURCE_PURIFIER;
const RESOURCE_BATTERY: RESOURCE_BATTERY;

const RESOURCE_COMPOSITE: RESOURCE_COMPOSITE;
const RESOURCE_CRYSTAL: RESOURCE_CRYSTAL;
const RESOURCE_LIQUID: RESOURCE_LIQUID;

const RESOURCE_WIRE: RESOURCE_WIRE;
const RESOURCE_SWITCH: RESOURCE_SWITCH;
const RESOURCE_TRANSISTOR: RESOURCE_TRANSISTOR;
const RESOURCE_MICROCHIP: RESOURCE_MICROCHIP;
const RESOURCE_CIRCUIT: RESOURCE_CIRCUIT;
const RESOURCE_DEVICE: RESOURCE_DEVICE;

const RESOURCE_CELL: RESOURCE_CELL;
const RESOURCE_PHLEGM: RESOURCE_PHLEGM;
const RESOURCE_TISSUE: RESOURCE_TISSUE;
const RESOURCE_MUSCLE: RESOURCE_MUSCLE;
const RESOURCE_ORGANOID: RESOURCE_ORGANOID;
const RESOURCE_ORGANISM: RESOURCE_ORGANISM;

const RESOURCE_ALLOY: RESOURCE_ALLOY;
const RESOURCE_TUBE: RESOURCE_TUBE;
const RESOURCE_FIXTURES: RESOURCE_FIXTURES;
const RESOURCE_FRAME: RESOURCE_FRAME;
const RESOURCE_HYDRAULICS: RESOURCE_HYDRAULICS;
const RESOURCE_MACHINE: RESOURCE_MACHINE;

const RESOURCE_CONDENSATE: RESOURCE_CONDENSATE;
const RESOURCE_CONCENTRATE: RESOURCE_CONCENTRATE;
const RESOURCE_EXTRACT: RESOURCE_EXTRACT;
const RESOURCE_SPIRIT: RESOURCE_SPIRIT;
const RESOURCE_EMANATION: RESOURCE_EMANATION;
const RESOURCE_ESSENCE: RESOURCE_ESSENCE;

const RESOURCES_ALL: ResourceConstant[];

const SUBSCRIPTION_TOKEN: SUBSCRIPTION_TOKEN;
const CPU_UNLOCK: CPU_UNLOCK;
const PIXEL: PIXEL;
const ACCESS_KEY: ACCESS_KEY;

const PIXEL_CPU_COST: 10000;

const CONTROLLER_LEVELS: { [level: number]: number };
const CONTROLLER_STRUCTURES: Record<BuildableStructureConstant, { [level: number]: number }>;

const CONTROLLER_DOWNGRADE: { [level: number]: number };
const CONTROLLER_DOWNGRADE_RESTORE: number;
const CONTROLLER_DOWNGRADE_SAFEMODE_THRESHOLD: number;
const CONTROLLER_CLAIM_DOWNGRADE: number;
const CONTROLLER_RESERVE: number;
const CONTROLLER_RESERVE_MAX: number;
const CONTROLLER_MAX_UPGRADE_PER_TICK: number;
const CONTROLLER_ATTACK_BLOCKED_UPGRADE: number;
const CONTROLLER_NUKE_BLOCKED_UPGRADE: number;

const SAFE_MODE_DURATION: 20000;
const SAFE_MODE_COOLDOWN: 50000;
const SAFE_MODE_COST: 1000;

const TOWER_HITS: number;
const TOWER_CAPACITY: number;
const TOWER_ENERGY_COST: number;
const TOWER_POWER_ATTACK: number;
const TOWER_POWER_HEAL: number;
const TOWER_POWER_REPAIR: number;
const TOWER_OPTIMAL_RANGE: number;
const TOWER_FALLOFF_RANGE: number;
const TOWER_FALLOFF: number;

const OBSERVER_HITS: number;
const OBSERVER_RANGE: number;

const POWER_BANK_HITS: number;
const POWER_BANK_CAPACITY_MAX: number;
const POWER_BANK_CAPACITY_MIN: number;
const POWER_BANK_CAPACITY_CRIT: number;
const POWER_BANK_DECAY: number;
const POWER_BANK_HIT_BACK: number;

const POWER_SPAWN_HITS: number;
const POWER_SPAWN_ENERGY_CAPACITY: number;
const POWER_SPAWN_POWER_CAPACITY: number;
const POWER_SPAWN_ENERGY_RATIO: number;

const EXTRACTOR_HITS: number;
const EXTRACTOR_COOLDOWN: number;

const LAB_HITS: number;
const LAB_MINERAL_CAPACITY: number;
const LAB_ENERGY_CAPACITY: number;
const LAB_BOOST_ENERGY: number;
const LAB_BOOST_MINERAL: number;
const LAB_COOLDOWN: number;
const LAB_REACTION_AMOUNT: number;

const GCL_POW: number;
const GCL_MULTIPLY: number;
const GCL_NOVICE: number;

const MODE_SIMULATION: string;
const MODE_SURVIVAL: string;
const MODE_WORLD: string;
const MODE_ARENA: string;

const TERRAIN_MASK_WALL: TERRAIN_MASK_WALL;
const TERRAIN_MASK_SWAMP: TERRAIN_MASK_SWAMP;
const TERRAIN_MASK_LAVA: TERRAIN_MASK_LAVA;

const MAX_CONSTRUCTION_SITES: number;
const MAX_CREEP_SIZE: number;

const MINERAL_REGEN_TIME: number;
const MINERAL_MIN_AMOUNT: Record<MineralConstant, number>;
const MINERAL_RANDOM_FACTOR: number;
...
const MINERAL_DENSITY_CHANGE: number;

const DENSITY_LOW: number;
const DENSITY_MODERATE: number;
const DENSITY_HIGH: number;
const DENSITY_ULTRA: number;

const DEPOSIT_EXHAUST_MULTIPLY: number;
const DEPOSIT_EXHAUST_POW: number;
const DEPOSIT_DECAY_TIME: number;

const TERMINAL_CAPACITY: number;
const TERMINAL_COOLDOWN: number;
const TERMINAL_HITS: number;
const TERMINAL_SEND_COST: number;
const TERMINAL_MIN_SEND: number;

const CONTAINER_HITS: number;
const CONTAINER_CAPACITY: number;
const CONTAINER_DECAY: number;
const CONTAINER_DECAY_TIME: number;
const CONTAINER_DECAY_TIME_OWNED: number;

const NUKER_HITS: number;
const NUKER_COOLDOWN: number;
const NUKER_ENERGY_CAPACITY: number;
const NUKER_GHODIUM_CAPACITY: number;
const NUKE_LAND_TIME: number;
const NUKE_RANGE: number;
const NUKE_DAMAGE: {
    [range: number]: number;
    0: number;
    1: number;
...
const INTERSHARD_RESOURCES: InterShardResourceConstant[];
...
const COMMODITIES: Record<CommoditiesTypes, CommodityEntry>;

const LOOK_CREEPS: LOOK_CREEPS;
const LOOK_ENERGY: LOOK_ENERGY;
const LOOK_RESOURCES: LOOK_RESOURCES;
const LOOK_SOURCES: LOOK_SOURCES;
const LOOK_MINERALS: LOOK_MINERALS;
const LOOK_DEPOSITS: LOOK_DEPOSITS;
const LOOK_STRUCTURES: LOOK_STRUCTURES;
const LOOK_FLAGS: LOOK_FLAGS;
const LOOK_CONSTRUCTION_SITES: LOOK_CONSTRUCTION_SITES;
const LOOK_NUKES: LOOK_NUKES;
const LOOK_TERRAIN: LOOK_TERRAIN;
const LOOK_TOMBSTONES: LOOK_TOMBSTONES;
const LOOK_POWER_CREEPS: LOOK_POWER_CREEPS;
const LOOK_RUINS: LOOK_RUINS;

const ORDER_SELL: ORDER_SELL;
const ORDER_BUY: ORDER_BUY;

const MARKET_FEE: 0.05;
const MARKET_MAX_ORDERS: 300;
const MARKET_ORDER_LIFE_TIME: 2592000000; // 1000*60*60*24*30

const INVADERS_ENERGY_GOAL: number;

const SYSTEM_USERNAME: string;
...
const EVENT_ATTACK: EVENT_ATTACK;
const EVENT_OBJECT_DESTROYED: EVENT_OBJECT_DESTROYED;
const EVENT_ATTACK_CONTROLLER: EVENT_ATTACK_CONTROLLER;
const EVENT_BUILD: EVENT_BUILD;
const EVENT_HARVEST: EVENT_HARVEST;
const EVENT_HEAL: EVENT_HEAL;
const EVENT_REPAIR: EVENT_REPAIR;
const EVENT_RESERVE_CONTROLLER: EVENT_RESERVE_CONTROLLER;
const EVENT_UPGRADE_CONTROLLER: EVENT_UPGRADE_CONTROLLER;
const EVENT_EXIT: EVENT_EXIT;
const EVENT_POWER: EVENT_POWER;
const EVENT_TRANSFER: EVENT_TRANSFER;

const EVENT_ATTACK_TYPE_MELEE: EVENT_ATTACK_TYPE_MELEE;
const EVENT_ATTACK_TYPE_RANGED: EVENT_ATTACK_TYPE_RANGED;
const EVENT_ATTACK_TYPE_RANGED_MASS: EVENT_ATTACK_TYPE_RANGED_MASS;
const EVENT_ATTACK_TYPE_DISMANTLE: EVENT_ATTACK_TYPE_DISMANTLE;
const EVENT_ATTACK_TYPE_HIT_BACK: EVENT_ATTACK_TYPE_HIT_BACK;
const EVENT_ATTACK_TYPE_NUKE: EVENT_ATTACK_TYPE_NUKE;

const EVENT_HEAL_TYPE_MELEE: EVENT_HEAL_TYPE_MELEE;
const EVENT_HEAL_TYPE_RANGED: EVENT_HEAL_TYPE_RANGED;

const POWER_LEVEL_MULTIPLY: 1000;
const POWER_LEVEL_POW: 2;
const POWER_CREEP_SPAWN_COOLDOWN: 28800000; // 8 * 3600 * 1000
const POWER_CREEP_DELETE_COOLDOWN: 86400000; // 24 * 3600 * 1000
...
const PWR_OPERATE_OBSERVER: PWR_OPERATE_OBSERVER;
const PWR_OPERATE_TERMINAL: PWR_OPERATE_TERMINAL;
const PWR_DISRUPT_SPAWN: PWR_DISRUPT_SPAWN;
const PWR_DISRUPT_TOWER: PWR_DISRUPT_TOWER;
const PWR_DISRUPT_SOURCE: PWR_DISRUPT_SOURCE;
const PWR_SHIELD: PWR_SHIELD;
const PWR_REGEN_SOURCE: PWR_REGEN_SOURCE;
const PWR_REGEN_MINERAL: PWR_REGEN_MINERAL;
const PWR_DISRUPT_TERMINAL: PWR_DISRUPT_TERMINAL;
const PWR_OPERATE_POWER: PWR_OPERATE_POWER;
const PWR_FORTIFY: PWR_FORTIFY;
const PWR_OPERATE_CONTROLLER: PWR_OPERATE_CONTROLLER;
const PWR_OPERATE_FACTORY: PWR_OPERATE_FACTORY;

const EFFECT_INVULNERABILITY: EFFECT_INVULNERABILITY;
const EFFECT_COLLAPSE_TIMER: EFFECT_COLLAPSE_TIMER;

const INVADER_CORE_HITS: 1000000;
...
const INVADER_CORE_EXPAND_TIME: 15000;
const INVADER_CORE_CONTROLLER_POWER: 100;
...
const STRONGHOLD_DECAY_TICKS: 150000;
...
const ConstructionSite: ConstructionSiteConstructor;
/**
...
const Deposit: DepositConstructor;
/**
...
const InterShardMemory: InterShardMemory;
/*
...
const Mineral: MineralConstructor;
/**
...
const PowerCreep: PowerCreepConstructor;
...
const RoomObject: RoomObjectConstructor;
...
const RoomPosition: RoomPositionConstructor;
/**
...
const StructureSpawn: StructureSpawnConstructor;
const Spawn: StructureSpawnConstructor; // legacy alias
...
const Structure: StructureConstructor;
...
const OwnedStructure: OwnedStructureConstructor;
...
const StructureController: StructureControllerConstructor;
...
const StructureExtension: StructureExtensionConstructor;
...
const StructureLink: StructureLinkConstructor;
...
const StructureKeeperLair: StructureKeeperLairConstructor;
...
const StructureObserver: StructureObserverConstructor;
...
const StructurePowerBank: StructurePowerBankConstructor;
...
const StructurePowerSpawn: StructurePowerSpawnConstructor;
...
const StructureRampart: StructureRampartConstructor;
...
const StructureRoad: StructureRoadConstructor;
...
const StructureStorage: StructureStorageConstructor;
...
const StructureWall: StructureWallConstructor;
...
const StructureExtractor: StructureExtractorConstructor;
...
const StructureLab: StructureLabConstructor;
...
const StructureTerminal: StructureTerminalConstructor;
...
const StructureContainer: StructureContainerConstructor;
...
const StructureNuker: StructureNukerConstructor;
...
const StructurePortal: StructurePortalConstructor;
...
const StructureFactory: StructureFactoryConstructor;
...
const StructureInvaderCore: StructureInvaderCoreConstructor;
...
const Tombstone: TombstoneConstructor;
}
